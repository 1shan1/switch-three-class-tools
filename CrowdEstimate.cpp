...
{
    netName_ = "/data_2/my_bishe_experiment/part-A/test/deploy_Muti_crowd_nobn.prototxt";
    modelName_="/data_2/my_bishe_experiment/part-A/test/model_iter_245000.caffemodel";
...
//float scale_factor = caffe::Frcnn::get_scale_factor(src.cols, src.rows, 600, 1000);
    ...
    cv::Mat x;
    cv::resize(src,x,cv::Size(src.cols/8*8,src.rows/8*8));
